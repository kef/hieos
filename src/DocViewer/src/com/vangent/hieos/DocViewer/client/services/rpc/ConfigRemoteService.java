...
public interface ConfigRemoteService extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static ConfigRemoteServiceAsync instance;
		public static ConfigRemoteServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(ConfigRemoteService.class);
			}
			return instance;
		}
	}
