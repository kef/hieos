...
/**
 * Class to handle all asynchronous web service requests to XCPD Responding Gateway (RG).
 *
 * @author Bernie Thuman
 */
public class XCPDRespondingGatewayAsync extends XCPDRespondingGateway {

    private final static Logger logger = Logger.getLogger(XCPDRespondingGatewayAsync.class);
