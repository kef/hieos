...
for %%I IN (c:\sun\sdk\lib\appserv-rt.jar) DO SET CP=!CP!;%%I
for %%I IN (c:\sun\sdk\lib\appserv-admin.jar) DO SET CP=!CP!;%%I
for %%I IN (c:\sun\sdk\lib\install\applications\jmsra\imqjmsra.jar) DO SET CP=!CP!;%%I
