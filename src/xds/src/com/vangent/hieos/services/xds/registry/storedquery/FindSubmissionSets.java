...
public class FindSubmissionSets extends StoredQuery {
    ...
    OMElement impl() throws XdsInternalException, XdsException {
        ...
        a("FROM RegistryPackage doc, ExternalIdentifier patId");
        n();
        if (source_id != null) {
            a(", ExternalIdentifier srcId");
        }
        n();
        ...
        n();
        a("  patId.identificationScheme='urn:uuid:6b5aea1a-874d-4603-a4bc-96a0a7b38446' AND ");
        n();
        a("  patId.value = '");
        a(patient_id);
        a("' ) ");
        ...
        if (source_id != null) {
            a("AND");
            n();
            a("(doc.id = srcId.registryobject AND	");
            n();
            a("  srcId.identificationScheme='urn:uuid:554ac39e-e3fe-47fe-b233-965d2a147832' AND ");
            n();
            a("  srcId.value IN ");
            a(source_id);
            a(" ) ");
        ...
        if (author_person != null) {
            ...
            n();
            a("  author.classificationScheme='urn:uuid:a7058bb9-b4e4-4307-ba5b-e3f0ab85e12d' AND ");
            n();
            a("  authorperson.parent = author.id AND");
            n();
            a("  authorperson.name = 'authorPerson' AND");
            n();
            a("  authorperson.value LIKE '" + author_person + "' )");
            n();
        }
