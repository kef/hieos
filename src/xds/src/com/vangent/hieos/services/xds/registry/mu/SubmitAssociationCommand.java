...
public class SubmitAssociationCommand extends MetadataUpdateCommand {
    ...
    protected boolean validate() throws XdsException {
        ...
        OMElement submittedAssoc = this.getTargetObject();
        ...
        rov.validate(submittedMetadata, MetadataType.ASSOC_SUBMISSION, registryResponse.registryErrorList, configActor);
    ...
    private void validateRegistryObjectPatientIds() throws XdsException {
        ...
        if (!sourcePatientId.equals(targetPatientId)) {
            throw new XdsException("Source registry object's patient identifier = "
                    + sourcePatientId
