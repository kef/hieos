 ...
 */
public class ADTPatientUpdateMessageHandler extends ADTMessageHandler {

    private final static Logger logger = Logger.getLogger(ADTPatientUpdateMessageHandler.class);
    ...
    public Message processMessage(Connection connection, Message inMessage) throws ApplicationException, HL7Exception {
        logger.info("Processing ADT Patient Update message ...");
