 ...
 */
public class ADTPatientAddMessageHandler extends ADTMessageHandler {

    private final static Logger logger = Logger.getLogger(ADTPatientAddMessageHandler.class);
    ...
    public Message processMessage(Connection connection, Message inMessage) throws ApplicationException, HL7Exception {
        logger.info("Processing ADT Patient Add message ...");
        ...
        try {
            ...
            SubjectBuilder subjectBuilder = new SubjectBuilder(getBuilderConfig(), terser);
            ...
            this.performAuditPatientIdentityFeed(
                    ...
                    ATNAHL7v2AuditEventPatientIdentityFeed.EventActionCode.CREATE,
                    subjectIdentifiers);
