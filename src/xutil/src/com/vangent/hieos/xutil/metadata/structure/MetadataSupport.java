...
public class MetadataSupport {
    ...
    static public boolean isV2Namespace(String ns) {
        return ns != null && (ns.equals(ebRSns2_uri) || ns.equals(ebRIMns2_uri) || ns.equals(ebQns2_uri));
    }

    static public boolean isV2Namespace(OMNamespace ns) {
