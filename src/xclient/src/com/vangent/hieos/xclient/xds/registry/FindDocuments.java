...
public class FindDocuments extends Sq {
    ...
    // BHT: QueryContents queryContents;

    String query_details() {
        return "FindDocuments " + ids;
    }

    public FindDocuments(boolean useLeafClass) {
        this.useLeafClass = useLeafClass;
        // BHT: this.queryContents = queryContents;
    }
    ...
    OMElement build(ArrayList<String> ids) {
        ...
        //BHT: queryContents.setRequestXML(query.get(0));
        return query.get(0);
    }
}
