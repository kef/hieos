...
public abstract class IdAllocator {
    ...
    //
    public String assign(Metadata metadata, String object_type, String external_identifier_uuid, HashMap<String, String> assignments, List<String> no_assign_uid_to)
        ...
        for (int i = 0; i < eos.size(); i++) {
            ...
            if (no_assign_uid_to != null && no_assign_uid_to.contains(id)) {
                continue;
            }
